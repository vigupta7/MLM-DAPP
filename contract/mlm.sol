...
contract ERC20 {
    ...
    function _burn(address account, uint256 value) internal {
        ...
        require(
            ...
            "Burn is allowed only after the contract hardcap is achieved."
        );
...
contract NewCoin is NewToken, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    function burn(uint256 amount) public returns (bool) {
        ...
        require(
            hardCapAchieved == true,
            "You can not burn token as hardcap is not achieved."
        );
